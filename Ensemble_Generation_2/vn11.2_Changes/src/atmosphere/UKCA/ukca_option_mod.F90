...
LOGICAL :: l_ukca_acure_bl_nuc             = .FALSE.
LOGICAL :: l_ukca_acure_ageing             = .FALSE.
LOGICAL :: l_ukca_acure_accumulation_width = .FALSE.
LOGICAL :: l_ukca_acure_aitken_width       = .FALSE.
LOGICAL :: l_ukca_acure_cloudph            = .FALSE.
LOGICAL :: l_ukca_acure_ff_ems             = .FALSE.
LOGICAL :: l_ukca_acure_bb_ems             = .FALSE.
LOGICAL :: l_ukca_acure_bf_ems             = .FALSE.
LOGICAL :: l_ukca_acure_ff_diameter        = .FALSE.
LOGICAL :: l_ukca_acure_bb_diameter        = .FALSE.
LOGICAL :: l_ukca_acure_bf_diameter        = .FALSE.
LOGICAL :: l_ukca_acure_su_parfrac         = .FALSE.
LOGICAL :: l_ukca_acure_su_diameter        = .FALSE.
LOGICAL :: l_ukca_acure_ss_flux            = .FALSE.
LOGICAL :: l_ukca_acure_anth_so2           = .FALSE.
LOGICAL :: l_ukca_acure_volc_so2           = .FALSE.
LOGICAL :: l_ukca_acure_bio_soa            = .FALSE.
LOGICAL :: l_ukca_acure_dms_flux           = .FALSE.
LOGICAL :: l_ukca_acure_aitken_ddrydepaer  = .FALSE.
LOGICAL :: l_ukca_acure_accum_ddrydepaer   = .FALSE.
LOGICAL :: l_ukca_acure_drydep_so2         = .FALSE.
LOGICAL :: l_ukca_acure_kappa_oc           = .FALSE.
LOGICAL :: l_ukca_acure_sigw               = .FALSE.
LOGICAL :: l_ukca_acure_dust_ems           = .FALSE.
LOGICAL :: l_ukca_acure_rain_frac          = .FALSE.
LOGICAL :: l_ukca_acure_rr_thres           = .FALSE.
...
REAL :: ukca_acure_bl_nuc             = rmdi
REAL :: ukca_acure_ageing             = rmdi
REAL :: ukca_acure_accumulation_width = rmdi
REAL :: ukca_acure_aitken_width       = rmdi
REAL :: ukca_acure_cloudph            = rmdi
REAL :: ukca_acure_ff_ems             = rmdi
REAL :: ukca_acure_bb_ems             = rmdi
REAL :: ukca_acure_bf_ems             = rmdi
REAL :: ukca_acure_ff_diameter        = rmdi
REAL :: ukca_acure_bb_diameter        = rmdi
REAL :: ukca_acure_bf_diameter        = rmdi
REAL :: ukca_acure_su_parfrac         = rmdi
REAL :: ukca_acure_su_diameter        = rmdi
REAL :: ukca_acure_ss_flux            = rmdi
REAL :: ukca_acure_anth_so2           = rmdi
REAL :: ukca_acure_volc_so2           = rmdi
REAL :: ukca_acure_bio_soa            = rmdi
REAL :: ukca_acure_dms_flux           = rmdi
REAL :: ukca_acure_aitken_ddrydepaer  = rmdi
REAL :: ukca_acure_accum_ddrydepaer   = rmdi
REAL :: ukca_acure_drydep_so2         = rmdi
REAL :: ukca_acure_kappa_oc           = rmdi
REAL :: ukca_acure_sigw               = rmdi
REAL :: ukca_acure_dust_ems           = rmdi
REAL :: ukca_acure_rain_frac          = rmdi
REAL :: ukca_acure_rr_thres           = rmdi
...
NAMELIST/run_ukca/ l_ukca, l_ukca_aie1, l_ukca_aie2,              &
         ...
         l_ukca_debug_asad,                                       &
         l_ukca_acure_bl_nuc, l_ukca_acure_ageing,                &
         l_ukca_acure_accumulation_width,                         &
         l_ukca_acure_aitken_width,                               &
         l_ukca_acure_cloudph, l_ukca_acure_ff_ems,               &
         l_ukca_acure_bb_ems, l_ukca_acure_bf_ems,                &
         l_ukca_acure_ff_diameter, l_ukca_acure_bb_diameter,      &
         l_ukca_acure_bf_diameter, l_ukca_acure_su_parfrac,       &
         l_ukca_acure_su_diameter, l_ukca_acure_ss_flux,          &
         l_ukca_acure_anth_so2, l_ukca_acure_volc_so2,            &
         l_ukca_acure_bio_soa, l_ukca_acure_dms_flux,             &
         l_ukca_acure_aitken_ddrydepaer,                          &
         l_ukca_acure_accum_ddrydepaer,                           &
         l_ukca_acure_drydep_so2, l_ukca_acure_kappa_oc,          &
         l_ukca_acure_sigw, l_ukca_acure_dust_ems,                &
         l_ukca_acure_rain_frac, l_ukca_acure_rr_thres,           &
         ukca_acure_bl_nuc, ukca_acure_ageing,                    &
         ukca_acure_accumulation_width,                           &
         ukca_acure_aitken_width,                                 &
         ukca_acure_cloudph, ukca_acure_ff_ems,                   &
         ukca_acure_bb_ems, ukca_acure_bf_ems,                    &
         ukca_acure_ff_diameter, ukca_acure_bb_diameter,          &
         ukca_acure_bf_diameter, ukca_acure_su_parfrac,           &
         ukca_acure_su_diameter, ukca_acure_ss_flux,              &
         ukca_acure_anth_so2, ukca_acure_volc_so2,                &
         ukca_acure_bio_soa, ukca_acure_dms_flux,                 &
         ukca_acure_aitken_ddrydepaer,                            &
         ukca_acure_accum_ddrydepaer,                             &
         ukca_acure_drydep_so2, ukca_acure_kappa_oc,              &
         ukca_acure_sigw, ukca_acure_dust_ems,                    &
         ukca_acure_rain_frac, ukca_acure_rr_thres
...
WRITE(lineBuffer,'(A,F16.4)')' max_ageair_reset_height= ', &
                                                    max_ageair_reset_height
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_bl_nuc = ', l_ukca_acure_bl_nuc
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_bl_nuc = ', ukca_acure_bl_nuc
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_ageing = ', l_ukca_acure_ageing
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_ageing = ', ukca_acure_ageing
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_accumulation_width = ', l_ukca_acure_accumulation_width
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_accumulation_width = ', ukca_acure_accumulation_width
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_aitken_width = ', l_ukca_acure_aitken_width
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_aitken_width = ', ukca_acure_aitken_width
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_cloudph = ', l_ukca_acure_cloudph
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_cloudph = ', ukca_acure_cloudph
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_ff_ems = ', l_ukca_acure_ff_ems
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_ff_ems = ', ukca_acure_ff_ems
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_bb_ems = ', l_ukca_acure_bb_ems
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_bb_ems = ', ukca_acure_bb_ems
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_bf_ems = ', l_ukca_acure_bf_ems
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_bf_ems = ', ukca_acure_bf_ems
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_ff_diameter = ', l_ukca_acure_ff_diameter
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_ff_diameter = ', ukca_acure_ff_diameter
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_bb_diameter = ', l_ukca_acure_bb_diameter
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_bb_diameter = ', ukca_acure_bb_diameter
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_bf_diameter = ', l_ukca_acure_bf_diameter
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_bf_diameter = ', ukca_acure_bf_diameter
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_su_parfrac = ', l_ukca_acure_su_parfrac
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_su_parfrac = ', ukca_acure_su_parfrac
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_su_diameter = ', l_ukca_acure_su_diameter
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_su_diameter = ', ukca_acure_su_diameter
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_ss_flux = ', l_ukca_acure_ss_flux
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_ss_flux = ', ukca_acure_ss_flux
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_anth_so2 = ', l_ukca_acure_anth_so2
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_anth_so2 = ', ukca_acure_anth_so2
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_volc_so2 = ', l_ukca_acure_volc_so2
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_volc_so2 = ', ukca_acure_volc_so2
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_bio_soa = ', l_ukca_acure_bio_soa
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_bio_soa = ', ukca_acure_bio_soa
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_dms_flux = ', l_ukca_acure_dms_flux
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_dms_flux = ', ukca_acure_dms_flux
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_aitken_ddrydepaer = ', l_ukca_acure_aitken_ddrydepaer
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_aitken_ddrydepaer = ', ukca_acure_aitken_ddrydepaer
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_accum_ddrydepaer = ', l_ukca_acure_accum_ddrydepaer
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_accum_ddrydepaer = ', ukca_acure_accum_ddrydepaer
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_drydep_so2 = ', l_ukca_acure_drydep_so2
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_drydep_so2 = ', ukca_acure_drydep_so2
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_kappa_oc = ', l_ukca_acure_kappa_oc
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_kappa_oc = ', ukca_acure_kappa_oc
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_sigw = ', l_ukca_acure_sigw
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_sigw = ', ukca_acure_sigw
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_dust_ems = ', l_ukca_acure_dust_ems
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_dust_ems = ', ukca_acure_dust_ems
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_rain_frac = ', l_ukca_acure_rain_frac
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_rain_frac = ', ukca_acure_rain_frac
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')' l_ukca_acure_rr_thres = ', l_ukca_acure_rr_thres
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' ukca_acure_rr_thres = ', ukca_acure_rr_thres
CALL umPrint(lineBuffer,src='ukca_option_mod')
...
TYPE my_namelist
  ...
  REAL :: ukca_acure_bl_nuc
  REAL :: ukca_acure_ageing
  REAL :: ukca_acure_accumulation_width
  REAL :: ukca_acure_aitken_width
  REAL :: ukca_acure_cloudph
  REAL :: ukca_acure_ff_ems
  REAL :: ukca_acure_bb_ems
  REAL :: ukca_acure_bf_ems
  REAL :: ukca_acure_ff_diameter
  REAL :: ukca_acure_bb_diameter
  REAL :: ukca_acure_bf_diameter
  REAL :: ukca_acure_su_parfrac
  REAL :: ukca_acure_su_diameter
  REAL :: ukca_acure_ss_flux
  REAL :: ukca_acure_anth_so2
  REAL :: ukca_acure_volc_so2
  REAL :: ukca_acure_bio_soa
  REAL :: ukca_acure_dms_flux
  REAL :: ukca_acure_aitken_ddrydepaer
  REAL :: ukca_acure_accum_ddrydepaer
  REAL :: ukca_acure_drydep_so2
  REAL :: ukca_acure_kappa_oc
  REAL :: ukca_acure_sigw
  REAL :: ukca_acure_dust_ems
  REAL :: ukca_acure_rain_frac
  REAL :: ukca_acure_rr_thres
  LOGICAL :: l_ukca
  LOGICAL :: l_ukca_aie1
  LOGICAL :: l_ukca_aie2
  ...
  LOGICAL :: l_ukca_acure_bl_nuc
  LOGICAL :: l_ukca_acure_ageing
  LOGICAL :: l_ukca_acure_accumulation_width
  LOGICAL :: l_ukca_acure_aitken_width
  LOGICAL :: l_ukca_acure_cloudph
  LOGICAL :: l_ukca_acure_ff_ems
  LOGICAL :: l_ukca_acure_bb_ems
  LOGICAL :: l_ukca_acure_bf_ems
  LOGICAL :: l_ukca_acure_ff_diameter
  LOGICAL :: l_ukca_acure_bb_diameter
  LOGICAL :: l_ukca_acure_bf_diameter
  LOGICAL :: l_ukca_acure_su_parfrac
  LOGICAL :: l_ukca_acure_su_diameter
  LOGICAL :: l_ukca_acure_ss_flux
  LOGICAL :: l_ukca_acure_anth_so2
  LOGICAL :: l_ukca_acure_volc_so2
  LOGICAL :: l_ukca_acure_bio_soa
  LOGICAL :: l_ukca_acure_dms_flux
  LOGICAL :: l_ukca_acure_aitken_ddrydepaer
  LOGICAL :: l_ukca_acure_accum_ddrydepaer
  LOGICAL :: l_ukca_acure_drydep_so2
  LOGICAL :: l_ukca_acure_kappa_oc
  LOGICAL :: l_ukca_acure_sigw
  LOGICAL :: l_ukca_acure_dust_ems
  LOGICAL :: l_ukca_acure_rain_frac
  LOGICAL :: l_ukca_acure_rr_thres
...
IF (mype == 0) THEN
  ...
  my_nml % ukca_acure_bl_nuc  = ukca_acure_bl_nuc
  my_nml % ukca_acure_ageing  = ukca_acure_ageing
  my_nml % ukca_acure_accumulation_width = ukca_acure_accumulation_width
  my_nml % ukca_acure_aitken_width = ukca_acure_aitken_width
  my_nml % ukca_acure_cloudph = ukca_acure_cloudph
  my_nml % ukca_acure_ff_ems  = ukca_acure_ff_ems
  my_nml % ukca_acure_bb_ems  = ukca_acure_bb_ems
  my_nml % ukca_acure_bf_ems  = ukca_acure_bf_ems
  my_nml % ukca_acure_ff_diameter = ukca_acure_ff_diameter
  my_nml % ukca_acure_bb_diameter = ukca_acure_bb_diameter
  my_nml % ukca_acure_bf_diameter = ukca_acure_bf_diameter
  my_nml % ukca_acure_su_parfrac = ukca_acure_su_parfrac
  my_nml % ukca_acure_su_diameter = ukca_acure_su_diameter
  my_nml % ukca_acure_ss_flux = ukca_acure_ss_flux
  my_nml % ukca_acure_anth_so2 = ukca_acure_anth_so2
  my_nml % ukca_acure_volc_so2 = ukca_acure_volc_so2
  my_nml % ukca_acure_bio_soa = ukca_acure_bio_soa
  my_nml % ukca_acure_dms_flux = ukca_acure_dms_flux
  my_nml % ukca_acure_aitken_ddrydepaer = ukca_acure_aitken_ddrydepaer
  my_nml % ukca_acure_accum_ddrydepaer = ukca_acure_accum_ddrydepaer
  my_nml % ukca_acure_drydep_so2 = ukca_acure_drydep_so2
  my_nml % ukca_acure_kappa_oc = ukca_acure_kappa_oc
  my_nml % ukca_acure_sigw    = ukca_acure_sigw
  my_nml % ukca_acure_dust_ems = ukca_acure_dust_ems
  my_nml % ukca_acure_rain_frac = ukca_acure_rain_frac
  my_nml % ukca_acure_rr_thres = ukca_acure_rr_thres
  ! end of reals
  ...
  my_nml % l_ukca_acure_bl_nuc = l_ukca_acure_bl_nuc
  my_nml % l_ukca_acure_ageing = l_ukca_acure_ageing
  my_nml % l_ukca_acure_accumulation_width = l_ukca_acure_accumulation_width
  my_nml % l_ukca_acure_aitken_width = l_ukca_acure_aitken_width
  my_nml % l_ukca_acure_cloudph = l_ukca_acure_cloudph
  my_nml % l_ukca_acure_ff_ems = l_ukca_acure_ff_ems
  my_nml % l_ukca_acure_bb_ems = l_ukca_acure_bb_ems
  my_nml % l_ukca_acure_bf_ems = l_ukca_acure_bf_ems
  my_nml % l_ukca_acure_ff_diameter = l_ukca_acure_ff_diameter
  my_nml % l_ukca_acure_bb_diameter = l_ukca_acure_bb_diameter
  my_nml % l_ukca_acure_bf_diameter = l_ukca_acure_bf_diameter
  my_nml % l_ukca_acure_su_parfrac = l_ukca_acure_su_parfrac
  my_nml % l_ukca_acure_su_diameter = l_ukca_acure_su_diameter
  my_nml % l_ukca_acure_ss_flux = l_ukca_acure_ss_flux
  my_nml % l_ukca_acure_anth_so2 = l_ukca_acure_anth_so2
  my_nml % l_ukca_acure_volc_so2 = l_ukca_acure_volc_so2
  my_nml % l_ukca_acure_bio_soa = l_ukca_acure_bio_soa
  my_nml % l_ukca_acure_dms_flux = l_ukca_acure_dms_flux
  my_nml % l_ukca_acure_aitken_ddrydepaer = l_ukca_acure_aitken_ddrydepaer
  my_nml % l_ukca_acure_accum_ddrydepaer = l_ukca_acure_accum_ddrydepaer
  my_nml % l_ukca_acure_drydep_so2 = l_ukca_acure_drydep_so2
  my_nml % l_ukca_acure_kappa_oc = l_ukca_acure_kappa_oc
  my_nml % l_ukca_acure_sigw   = l_ukca_acure_sigw
  my_nml % l_ukca_acure_dust_ems = l_ukca_acure_dust_ems
  my_nml % l_ukca_acure_rain_frac = l_ukca_acure_rain_frac
  my_nml % l_ukca_acure_rr_thres = l_ukca_acure_rr_thres
  ! end of logicals
...
IF (mype /= 0) THEN
  ...
  ukca_acure_bl_nuc   = my_nml % ukca_acure_bl_nuc
  ukca_acure_ageing   = my_nml % ukca_acure_ageing
  ukca_acure_accumulation_width = my_nml % ukca_acure_accumulation_width
  ukca_acure_aitken_width = my_nml % ukca_acure_aitken_width
  ukca_acure_cloudph  = my_nml % ukca_acure_cloudph
  ukca_acure_ff_ems   = my_nml % ukca_acure_ff_ems
  ukca_acure_bb_ems   = my_nml % ukca_acure_bb_ems
  ukca_acure_bf_ems   = my_nml % ukca_acure_bf_ems
  ukca_acure_ff_diameter = my_nml % ukca_acure_ff_diameter
  ukca_acure_bb_diameter = my_nml % ukca_acure_bb_diameter
  ukca_acure_bf_diameter = my_nml % ukca_acure_bf_diameter
  ukca_acure_su_parfrac  = my_nml % ukca_acure_su_parfrac
  ukca_acure_su_diameter = my_nml % ukca_acure_su_diameter
  ukca_acure_ss_flux  = my_nml % ukca_acure_ss_flux
  ukca_acure_anth_so2 = my_nml % ukca_acure_anth_so2
  ukca_acure_volc_so2 = my_nml % ukca_acure_volc_so2
  ukca_acure_bio_soa  = my_nml % ukca_acure_bio_soa
  ukca_acure_dms_flux = my_nml % ukca_acure_dms_flux
  ukca_acure_aitken_ddrydepaer = my_nml % ukca_acure_aitken_ddrydepaer
  ukca_acure_accum_ddrydepaer  = my_nml % ukca_acure_accum_ddrydepaer
  ukca_acure_drydep_so2 = my_nml % ukca_acure_drydep_so2
  ukca_acure_kappa_oc   = my_nml % ukca_acure_kappa_oc
  ukca_acure_sigw       = my_nml % ukca_acure_sigw
  ukca_acure_dust_ems   = my_nml % ukca_acure_dust_ems
  ukca_acure_rain_frac  = my_nml % ukca_acure_rain_frac
  ukca_acure_rr_thres   = my_nml % ukca_acure_rr_thres
  ! end of reals
  ...
  l_ukca_acure_bl_nuc  = my_nml % l_ukca_acure_bl_nuc
  l_ukca_acure_ageing  = my_nml % l_ukca_acure_ageing
  l_ukca_acure_accumulation_width = my_nml % l_ukca_acure_accumulation_width
  l_ukca_acure_aitken_width = my_nml % l_ukca_acure_aitken_width
  l_ukca_acure_cloudph = my_nml % l_ukca_acure_cloudph
  l_ukca_acure_ff_ems  = my_nml % l_ukca_acure_ff_ems
  l_ukca_acure_bb_ems  = my_nml % l_ukca_acure_bb_ems
  l_ukca_acure_bf_ems  = my_nml % l_ukca_acure_bf_ems
  l_ukca_acure_ff_diameter = my_nml % l_ukca_acure_ff_diameter
  l_ukca_acure_bb_diameter = my_nml % l_ukca_acure_bb_diameter
  l_ukca_acure_bf_diameter = my_nml % l_ukca_acure_bf_diameter
  l_ukca_acure_su_parfrac  = my_nml % l_ukca_acure_su_parfrac
  l_ukca_acure_su_diameter = my_nml % l_ukca_acure_su_diameter
  l_ukca_acure_ss_flux  = my_nml % l_ukca_acure_ss_flux
  l_ukca_acure_anth_so2 = my_nml % l_ukca_acure_anth_so2
  l_ukca_acure_volc_so2 = my_nml % l_ukca_acure_volc_so2
  l_ukca_acure_bio_soa  = my_nml % l_ukca_acure_bio_soa
  l_ukca_acure_dms_flux = my_nml % l_ukca_acure_dms_flux
  l_ukca_acure_aitken_ddrydepaer = my_nml % l_ukca_acure_aitken_ddrydepaer
  l_ukca_acure_accum_ddrydepaer  = my_nml % l_ukca_acure_accum_ddrydepaer
  l_ukca_acure_drydep_so2 = my_nml % l_ukca_acure_drydep_so2
  l_ukca_acure_kappa_oc = my_nml % l_ukca_acure_kappa_oc
  l_ukca_acure_sigw     = my_nml % l_ukca_acure_sigw
  l_ukca_acure_dust_ems = my_nml % l_ukca_acure_dust_ems
  l_ukca_acure_rain_frac = my_nml % l_ukca_acure_rain_frac
  l_ukca_acure_rr_thres = my_nml % l_ukca_acure_rr_thres
  ! end of logicals
