...
LOGICAL :: l_acure_carb_bb_vertical           = .FALSE.
...
LOGICAL :: l_acure_anthropogenic_so2_emission_height           = .FALSE.
...
LOGICAL :: l_acure_deposition_rate_substep           = .FALSE.
LOGICAL :: l_acure_kappa_oc           = .FALSE.
LOGICAL :: l_acure_sig_w           = .FALSE.
LOGICAL :: l_acure_rain_frac           = .FALSE.
LOGICAL :: l_acure_cloud_ice_thresh           = .FALSE.
LOGICAL :: l_acure_convective_plume_scavenging           = .FALSE.
LOGICAL :: l_acure_bc_ri           = .FALSE.
LOGICAL :: l_acure_oxidants           = .FALSE.
LOGICAL :: l_acure_in_cloud_so2_oxidisation           = .FALSE.
LOGICAL :: l_acure_dp_cor_strat           = .FALSE.
LOGICAL :: l_acure_cloud_drop_spectral_dispersion           = .FALSE.
LOGICAL :: l_acure_autoconversion           = .FALSE.
LOGICAL :: l_acure_ar           = .FALSE.
LOGICAL :: l_acure_ice_width           = .FALSE.
LOGICAL :: l_acure_mp_dz_scal           = .FALSE.
...
REAL :: acure_carb_ff_ems_region_1    = rmdi
REAL :: acure_carb_ff_ems_region_2    = rmdi
REAL :: acure_carb_ff_ems_region_3    = rmdi
REAL :: acure_carb_ff_ems_region_4    = rmdi
REAL :: acure_carb_ff_ems_region_5    = rmdi
REAL :: acure_carb_ff_ems_region_6    = rmdi
REAL :: acure_carb_bb_ems_region_1    = rmdi
REAL :: acure_carb_bb_ems_region_2    = rmdi
REAL :: acure_carb_bb_ems_region_3    = rmdi
REAL :: acure_carb_bb_ems_region_4    = rmdi
REAL :: acure_carb_bb_ems_region_5    = rmdi
REAL :: acure_carb_bb_ems_region_6    = rmdi
REAL :: acure_carb_res_ems_region_1   = rmdi
REAL :: acure_carb_res_ems_region_2   = rmdi
REAL :: acure_carb_res_ems_region_3   = rmdi
REAL :: acure_carb_res_ems_region_4   = rmdi
REAL :: acure_carb_res_ems_region_5   = rmdi
REAL :: acure_anth_so2_region_1       = rmdi
REAL :: acure_anth_so2_region_2       = rmdi
REAL :: acure_anth_so2_region_3       = rmdi
REAL :: acure_anth_so2_region_4       = rmdi
REAL :: acure_anth_so2_region_5       = rmdi
REAL :: acure_carb_ff_diam            = rmdi
REAL :: acure_carb_bb_diam            = rmdi
REAL :: acure_carb_res_diam           = rmdi
REAL :: acure_carb_bb_vertical        = rmdi
REAL :: acure_prim_moc                = rmdi
REAL :: acure_prim_so4_diam           = rmdi
REAL :: acure_sea_spray           = rmdi
REAL :: acure_anthropogenic_so2_emission_height           = rmdi
...
REAL :: acure_deposition_rate_substep           = rmdi
REAL :: acure_kappa_oc           = rmdi
REAL :: acure_sig_w           = rmdi
REAL :: acure_rain_frac           = rmdi
REAL :: acure_cloud_ice_thresh           = rmdi
REAL :: acure_convective_plume_scavenging           = rmdi
REAL :: acure_bc_ri           = rmdi
REAL :: acure_oxidants           = rmdi
REAL :: acure_in_cloud_so2_oxidisation           = rmdi
REAL :: acure_dp_cor_strat           = rmdi
REAL :: acure_cloud_drop_spectral_dispersion           = rmdi
REAL :: acure_autoconversion           = rmdi
REAL :: acure_ar           = rmdi
REAL :: acure_ice_width           = rmdi
REAL :: acure_mp_dz_scal           = rmdi
...
NAMELIST/run_ukca/ l_ukca, l_ukca_aie1, l_ukca_aie2,              &
         ...
         l_acure_carb_ff_ems, l_acure_carb_bb_ems,                &
         l_acure_carb_res_ems, l_acure_anth_so2,                  &
         acure_carb_ff_ems_region_1, acure_carb_ff_ems_region_2,  &
         acure_carb_ff_ems_region_3, acure_carb_ff_ems_region_4,  &
         acure_carb_ff_ems_region_5, acure_carb_ff_ems_region_6,  &
         acure_carb_bb_ems_region_1, acure_carb_bb_ems_region_2,  &
         acure_carb_bb_ems_region_3, acure_carb_bb_ems_region_4,  &
         acure_carb_bb_ems_region_5, acure_carb_bb_ems_region_6,  &
         acure_carb_res_ems_region_1, acure_carb_res_ems_region_2,&
         acure_carb_res_ems_region_3, acure_carb_res_ems_region_4,&
         acure_carb_res_ems_region_5, acure_anth_so2_region_1,    &
         acure_anth_so2_region_2, acure_anth_so2_region_3,        &
         acure_anth_so2_region_4, acure_anth_so2_region_5,        &
         l_acure_carb_ff_diam, acure_carb_ff_diam,                &
         l_acure_carb_bb_diam, acure_carb_bb_diam,                &
         l_acure_carb_res_diam, acure_carb_res_diam,              &
         l_acure_carb_bb_vertical, acure_carb_bb_vertical,        &
         l_acure_prim_moc, acure_prim_moc,                        &
         l_acure_prim_so4_diam, acure_prim_so4_diam,              &
         l_acure_sea_spray, acure_sea_spray,                      &
         l_acure_anthropogenic_so2_emission_height,               &
         acure_anthropogenic_so2_emission_height,                 &
         ...
         l_acure_deposition_rate_substep, acure_deposition_rate_substep, &
         l_acure_kappa_oc, acure_kappa_oc,                        &
         l_acure_sig_w, acure_sig_w,                              &
         l_acure_rain_frac, acure_rain_frac,                      &
         ...
         l_acure_oxidants, acure_oxidants,                        &
         l_acure_in_cloud_so2_oxidisation, acure_in_cloud_so2_oxidisation, &
         l_acure_dp_cor_strat, acure_dp_cor_strat,                &
         l_acure_cloud_drop_spectral_dispersion,                  &
         acure_cloud_drop_spectral_dispersion,                    &
         l_acure_autoconversion, acure_autoconversion,            &
         l_acure_ar, acure_ar,                                    &
         l_acure_ice_width, acure_ice_width,                      &
         l_acure_mp_dz_scal, acure_mp_dz_scal, l_acure_pcalc_index
...
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_ff_ems_region_1 = ',  &
                                                     acure_carb_ff_ems_region_1
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_ff_ems_region_2 = ',  &
                                                     acure_carb_ff_ems_region_2
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_ff_ems_region_3 = ',  &
                                                     acure_carb_ff_ems_region_3
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_ff_ems_region_4 = ',  &
                                                     acure_carb_ff_ems_region_4
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_ff_ems_region_5 = ',  &
                                                     acure_carb_ff_ems_region_5
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_ff_ems_region_6 = ',  &
                                                     acure_carb_ff_ems_region_6
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')'  l_acure_carb_bb_ems = ', l_acure_carb_bb_ems
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_bb_ems_region_1 = ',  &
                                                     acure_carb_bb_ems_region_1
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_bb_ems_region_2 = ',  &
                                                     acure_carb_bb_ems_region_2
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_bb_ems_region_3 = ',  &
                                                     acure_carb_bb_ems_region_3
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_bb_ems_region_4 = ',  &
                                                     acure_carb_bb_ems_region_4
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_bb_ems_region_5 = ',  &
                                                     acure_carb_bb_ems_region_5
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_bb_ems_region_6 = ',  &
                                                     acure_carb_bb_ems_region_6
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')'  l_acure_carb_res_ems = ', l_acure_carb_res_ems
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_res_ems_region_1 = ',  &
                                                    acure_carb_res_ems_region_1
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_res_ems_region_2 = ',  &
                                                    acure_carb_res_ems_region_2
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_res_ems_region_3 = ',  &
                                                    acure_carb_res_ems_region_3
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_res_ems_region_4 = ',  &
                                                    acure_carb_res_ems_region_4
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_res_ems_region_5 = ',  &
                                                    acure_carb_res_ems_region_5
CALL umPrint(lineBuffer,src='ukca_option_mod')
...
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')'  l_acure_carb_bb_vertical = ',  &
                                                      l_acure_carb_bb_vertical
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_carb_bb_vertical = ',  &
                                                        acure_carb_bb_vertical
CALL umPrint(lineBuffer,src='ukca_option_mod')
...
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_anth_so2_region_1 = ',  &
                                                        acure_anth_so2_region_1
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_anth_so2_region_2 = ',  &
                                                        acure_anth_so2_region_2
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_anth_so2_region_3 = ',  &
                                                        acure_anth_so2_region_3
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_anth_so2_region_4 = ',  &
                                                        acure_anth_so2_region_4
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_anth_so2_region_5 = ',  &
                                                        acure_anth_so2_region_5
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')'  l_acure_anthropogenic_so2_emission_height = ',&
                                      l_acure_anthropogenic_so2_emission_height
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_anthropogenic_so2_emission_height = ',&
                                        acure_anthropogenic_so2_emission_height
CALL umPrint(lineBuffer,src='ukca_option_mod')
...
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')'  l_acure_deposition_rate_substep = ',&
                                                l_acure_deposition_rate_substep
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_deposition_rate_substep = ',&
                                                  acure_deposition_rate_substep
CALL umPrint(lineBuffer,src='ukca_option_mod')
...
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')'  l_acure_rain_frac = ', l_acure_rain_frac
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_rain_frac = ',   acure_rain_frac
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')'  l_acure_cloud_ice_thresh = ',&
                                                       l_acure_cloud_ice_thresh
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_cloud_ice_thresh = ', &
...
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')'  l_acure_oxidants = ', l_acure_oxidants
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_oxidants = ',   acure_oxidants
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')'  l_acure_in_cloud_so2_oxidisation = ', &
                                               l_acure_in_cloud_so2_oxidisation
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_in_cloud_so2_oxidisation = ', &
                                                 acure_in_cloud_so2_oxidisation
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')'  l_acure_dp_cor_strat = ', l_acure_dp_cor_strat
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_dp_cor_strat = ',   acure_dp_cor_strat
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')'  l_acure_cloud_drop_spectral_dispersion = ', &
                                         l_acure_cloud_drop_spectral_dispersion
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_cloud_drop_spectral_dispersion = ', &
                                           acure_cloud_drop_spectral_dispersion
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')'  l_acure_autoconversion = ', l_acure_autoconversion
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_autoconversion = ',   acure_autoconversion
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')'  l_acure_ar = ', l_acure_ar
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_ar = ',   acure_ar
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')'  l_acure_ice_width = ', l_acure_ice_width
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_ice_width = ',   acure_ice_width
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,L1)')'  l_acure_mp_dz_scal = ', l_acure_mp_dz_scal
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' acure_mp_dz_scal = ',   acure_mp_dz_scal
CALL umPrint(lineBuffer,src='ukca_option_mod')
WRITE(lineBuffer,'(A,F16.4)')' l_acure_pcalc_index = ',   l_acure_pcalc_index
CALL umPrint(lineBuffer,src='ukca_option_mod')
...
TYPE my_namelist
  ...
  REAL :: acure_cloud_ph
  REAL :: acure_carb_ff_ems_region_1
  REAL :: acure_carb_ff_ems_region_2
  REAL :: acure_carb_ff_ems_region_3
  REAL :: acure_carb_ff_ems_region_4
  REAL :: acure_carb_ff_ems_region_5
  REAL :: acure_carb_ff_ems_region_6
  REAL :: acure_carb_bb_ems_region_1
  REAL :: acure_carb_bb_ems_region_2
  REAL :: acure_carb_bb_ems_region_3
  REAL :: acure_carb_bb_ems_region_4
  REAL :: acure_carb_bb_ems_region_5
  REAL :: acure_carb_bb_ems_region_6
  REAL :: acure_carb_res_ems_region_1
  REAL :: acure_carb_res_ems_region_2
  REAL :: acure_carb_res_ems_region_3
  REAL :: acure_carb_res_ems_region_4
  REAL :: acure_carb_res_ems_region_5
  REAL :: acure_carb_ff_diam
  REAL :: acure_carb_bb_diam
  REAL :: acure_carb_res_diam
  REAL :: acure_carb_bb_vertical
  REAL :: acure_prim_moc
  REAL :: acure_prim_so4_diam
  REAL :: acure_sea_spray
  REAL :: acure_anth_so2_region_1
  REAL :: acure_anth_so2_region_2
  REAL :: acure_anth_so2_region_3
  REAL :: acure_anth_so2_region_4
  REAL :: acure_anth_so2_region_5
  REAL :: acure_anthropogenic_so2_emission_height
  REAL :: acure_volc_so2
  REAL :: acure_bvoc_soa
  REAL :: acure_dms
  ...
  REAL :: acure_deposition_rate_substep
  REAL :: acure_kappa_oc
  REAL :: acure_sig_w
  REAL :: acure_rain_frac
  REAL :: acure_cloud_ice_thresh
  REAL :: acure_convective_plume_scavenging
  REAL :: acure_bc_ri
  REAL :: acure_oxidants
  REAL :: acure_in_cloud_so2_oxidisation
  REAL :: acure_dp_cor_strat
  REAL :: acure_cloud_drop_spectral_dispersion
  REAL :: acure_autoconversion
  REAL :: acure_ar
  REAL :: acure_ice_width
  REAL :: acure_mp_dz_scal
  LOGICAL :: l_ukca
  LOGICAL :: l_ukca_aie1
  LOGICAL :: l_ukca_aie2
  ...
  LOGICAL :: l_acure_deposition_rate_substep
  LOGICAL :: l_acure_kappa_oc
  LOGICAL :: l_acure_sig_w
  LOGICAL :: l_acure_rain_frac
  LOGICAL :: l_acure_cloud_ice_thresh
  LOGICAL :: l_acure_convective_plume_scavenging
  LOGICAL :: l_acure_bc_ri
  LOGICAL :: l_acure_oxidants
  LOGICAL :: l_acure_in_cloud_so2_oxidisation
  LOGICAL :: l_acure_dp_cor_strat
  LOGICAL :: l_acure_cloud_drop_spectral_dispersion
  LOGICAL :: l_acure_autoconversion
  LOGICAL :: l_acure_ar
  LOGICAL :: l_acure_ice_width
  LOGICAL :: l_acure_mp_dz_scal
...
IF (mype == 0) THEN
  ...
  my_nml % acure_carb_ff_ems_region_1 = acure_carb_ff_ems_region_1
  my_nml % acure_carb_ff_ems_region_2 = acure_carb_ff_ems_region_2
  my_nml % acure_carb_ff_ems_region_3 = acure_carb_ff_ems_region_3
  my_nml % acure_carb_ff_ems_region_4 = acure_carb_ff_ems_region_4
  my_nml % acure_carb_ff_ems_region_5 = acure_carb_ff_ems_region_5
  my_nml % acure_carb_ff_ems_region_6 = acure_carb_ff_ems_region_6
  my_nml % acure_carb_bb_ems_region_1 = acure_carb_bb_ems_region_1
  my_nml % acure_carb_bb_ems_region_2 = acure_carb_bb_ems_region_2
  my_nml % acure_carb_bb_ems_region_3 = acure_carb_bb_ems_region_3
  my_nml % acure_carb_bb_ems_region_4 = acure_carb_bb_ems_region_4
  my_nml % acure_carb_bb_ems_region_5 = acure_carb_bb_ems_region_5
  my_nml % acure_carb_bb_ems_region_6 = acure_carb_bb_ems_region_6
  my_nml % acure_carb_res_ems_region_1 = acure_carb_res_ems_region_1
  my_nml % acure_carb_res_ems_region_2 = acure_carb_res_ems_region_2
  my_nml % acure_carb_res_ems_region_3 = acure_carb_res_ems_region_3
  my_nml % acure_carb_res_ems_region_4 = acure_carb_res_ems_region_4
  my_nml % acure_carb_res_ems_region_5 = acure_carb_res_ems_region_5
  ...
  my_nml % acure_carb_bb_vertical = acure_carb_bb_vertical
  my_nml % acure_prim_moc = acure_prim_moc
  my_nml % acure_prim_so4_diam = acure_prim_so4_diam
  my_nml % acure_sea_spray = acure_sea_spray
  my_nml % acure_anth_so2_region_1 = acure_anth_so2_region_1
  my_nml % acure_anth_so2_region_2 = acure_anth_so2_region_2
  my_nml % acure_anth_so2_region_3 = acure_anth_so2_region_3
  my_nml % acure_anth_so2_region_4 = acure_anth_so2_region_4
  my_nml % acure_anth_so2_region_5 = acure_anth_so2_region_5
  my_nml % acure_anthropogenic_so2_emission_height = &
                                        acure_anthropogenic_so2_emission_height
  ...
  my_nml % acure_deposition_rate_substep = acure_deposition_rate_substep
  my_nml % acure_kappa_oc = acure_kappa_oc
  my_nml % acure_sig_w = acure_sig_w
  my_nml % acure_rain_frac = acure_rain_frac
  my_nml % acure_cloud_ice_thresh = acure_cloud_ice_thresh
  my_nml % acure_convective_plume_scavenging = &
                                              acure_convective_plume_scavenging
  my_nml % acure_bc_ri = acure_bc_ri
  my_nml % acure_oxidants = acure_oxidants
  my_nml % acure_in_cloud_so2_oxidisation = acure_in_cloud_so2_oxidisation
  my_nml % acure_dp_cor_strat = acure_dp_cor_strat
  my_nml % acure_cloud_drop_spectral_dispersion = &
                                           acure_cloud_drop_spectral_dispersion
  my_nml % acure_autoconversion = acure_autoconversion
  my_nml % acure_ar = acure_ar
  my_nml % acure_ice_width = acure_ice_width
  my_nml % acure_mp_dz_scal = acure_mp_dz_scal
  ! end of reals
  ...
  my_nml % l_acure_carb_bb_vertical = l_acure_carb_bb_vertical
  ...
  my_nml % l_acure_anthropogenic_so2_emission_height = &
                                      l_acure_anthropogenic_so2_emission_height
  ...
  my_nml % l_acure_deposition_rate_substep = l_acure_deposition_rate_substep
  my_nml % l_acure_kappa_oc = l_acure_kappa_oc
  my_nml % l_acure_sig_w = l_acure_sig_w
  my_nml % l_acure_rain_frac = l_acure_rain_frac
  my_nml % l_acure_cloud_ice_thresh = l_acure_cloud_ice_thresh
  my_nml % l_acure_convective_plume_scavenging = &
                                            l_acure_convective_plume_scavenging
  my_nml % l_acure_bc_ri = l_acure_bc_ri
  my_nml % l_acure_oxidants = l_acure_oxidants
  my_nml % l_acure_in_cloud_so2_oxidisation = l_acure_in_cloud_so2_oxidisation
  my_nml % l_acure_dp_cor_strat = l_acure_dp_cor_strat
  my_nml % l_acure_cloud_drop_spectral_dispersion = &
                                         l_acure_cloud_drop_spectral_dispersion
  my_nml % l_acure_autoconversion = l_acure_autoconversion
  my_nml % l_acure_ar = l_acure_ar
  my_nml % l_acure_ice_width = l_acure_ice_width
  my_nml % l_acure_mp_dz_scal = l_acure_mp_dz_scal
...
IF (mype /= 0) THEN
  ...
  acure_carb_ff_ems_region_1 = my_nml % acure_carb_ff_ems_region_1
  acure_carb_ff_ems_region_2 = my_nml % acure_carb_ff_ems_region_2
  acure_carb_ff_ems_region_3 = my_nml % acure_carb_ff_ems_region_3
  acure_carb_ff_ems_region_4 = my_nml % acure_carb_ff_ems_region_4
  acure_carb_ff_ems_region_5 = my_nml % acure_carb_ff_ems_region_5
  acure_carb_ff_ems_region_6 = my_nml % acure_carb_ff_ems_region_6
  acure_carb_bb_ems_region_1 = my_nml % acure_carb_bb_ems_region_1
  acure_carb_bb_ems_region_2 = my_nml % acure_carb_bb_ems_region_2
  acure_carb_bb_ems_region_3 = my_nml % acure_carb_bb_ems_region_3
  acure_carb_bb_ems_region_4 = my_nml % acure_carb_bb_ems_region_4
  acure_carb_bb_ems_region_5 = my_nml % acure_carb_bb_ems_region_5
  acure_carb_bb_ems_region_6 = my_nml % acure_carb_bb_ems_region_6
  acure_carb_res_ems_region_1 = my_nml % acure_carb_res_ems_region_1
  acure_carb_res_ems_region_2 = my_nml % acure_carb_res_ems_region_2
  acure_carb_res_ems_region_3 = my_nml % acure_carb_res_ems_region_3
  acure_carb_res_ems_region_4 = my_nml % acure_carb_res_ems_region_4
  acure_carb_res_ems_region_5 = my_nml % acure_carb_res_ems_region_5
  ...
  acure_carb_bb_vertical = my_nml % acure_carb_bb_vertical
  acure_prim_moc = my_nml % acure_prim_moc
  acure_prim_so4_diam = my_nml % acure_prim_so4_diam
  acure_sea_spray = my_nml % acure_sea_spray
  acure_anth_so2_region_1 = my_nml % acure_anth_so2_region_1
  acure_anth_so2_region_2 = my_nml % acure_anth_so2_region_2
  acure_anth_so2_region_3 = my_nml % acure_anth_so2_region_3
  acure_anth_so2_region_4 = my_nml % acure_anth_so2_region_4
  acure_anth_so2_region_5 = my_nml % acure_anth_so2_region_5
  acure_anthropogenic_so2_emission_height = &
                               my_nml % acure_anthropogenic_so2_emission_height
  ...
  acure_deposition_rate_substep = my_nml % acure_deposition_rate_substep
  acure_kappa_oc = my_nml % acure_kappa_oc
  acure_sig_w = my_nml % acure_sig_w
  acure_rain_frac = my_nml % acure_rain_frac
  acure_cloud_ice_thresh = my_nml % acure_cloud_ice_thresh
  acure_convective_plume_scavenging = &
                                     my_nml % acure_convective_plume_scavenging
  acure_bc_ri = my_nml % acure_bc_ri
  acure_oxidants = my_nml % acure_oxidants
  acure_in_cloud_so2_oxidisation = my_nml % acure_in_cloud_so2_oxidisation
  acure_dp_cor_strat = my_nml % acure_dp_cor_strat
  acure_cloud_drop_spectral_dispersion = &
                                  my_nml % acure_cloud_drop_spectral_dispersion
  acure_autoconversion = my_nml % acure_autoconversion
  acure_ar = my_nml % acure_ar
  acure_ice_width = my_nml % acure_ice_width
  acure_mp_dz_scal = my_nml % acure_mp_dz_scal
  ! end of reals
  ...
  l_acure_carb_bb_vertical = my_nml % l_acure_carb_bb_vertical
  ...
  l_acure_deposition_rate_substep = my_nml % l_acure_deposition_rate_substep
  l_acure_kappa_oc = my_nml % l_acure_kappa_oc
  l_acure_sig_w = my_nml % l_acure_sig_w
  l_acure_rain_frac = my_nml % l_acure_rain_frac
  l_acure_cloud_ice_thresh = my_nml % l_acure_cloud_ice_thresh
  l_acure_convective_plume_scavenging = &
                                   my_nml % l_acure_convective_plume_scavenging
  l_acure_bc_ri = my_nml % l_acure_bc_ri
  l_acure_oxidants = my_nml % l_acure_oxidants
  l_acure_in_cloud_so2_oxidisation = my_nml % l_acure_in_cloud_so2_oxidisation
  l_acure_dp_cor_strat = my_nml % l_acure_dp_cor_strat
  l_acure_cloud_drop_spectral_dispersion = &
                                my_nml % l_acure_cloud_drop_spectral_dispersion
  l_acure_autoconversion = my_nml % l_acure_autoconversion
  l_acure_ar = my_nml % l_acure_ar
  l_acure_ice_width = my_nml % l_acure_ice_width
  l_acure_mp_dz_scal = my_nml % l_acure_mp_dz_scal
